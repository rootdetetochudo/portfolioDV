...
const Contact = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await axios.post("https://discord.com/api/webhooks/1239220299178971246/XwjaTjd766lLJGlAcwN3PXDsWPfQUc6eH4v2u0uwaLoH78kvmMhvHcyPobCyAupzNSta", {
        content: `New message from ${form.name} (${form.email}): ${form.message}`,
      });
      ...
      console.log("Error while sending message to Discord webhook: ", error);
      setModalContent({
        title: "Error!",
